...
la lista ordenada.
 */
package colleciones001;

import java.util.Scanner;
import Service.MascotaService;

public class Colleciones001 {
    ...
    public static void main(String[] args) {
        ...
        ms.datos();
            ...
            otramascota = leer.next();
        }
        while(otramascota.equalsIgnoreCase("si"));
        
        ms.mostar();
        
        System.out.println("Indique el perro a  eliminar del listado?");
        String borrar = leer.next();
        ms.eliminarMascota(borrar);
